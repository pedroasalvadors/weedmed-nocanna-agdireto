...
const doctors = [
  {
    id: 1,
    name: 'Dr. Marcos Pereira Dias',
    crm: 'CRM 20905-SC',
    experience: '+800 atendimentos',
    focus: 'Dor crônica e traumatologia',
    description: 'Traumatologista especializado em medicina integrativa e tratamento da dor crônica.',
    image: '/marcos-dias.webp',
  },
  {
    id: 2,
  ...
  {
    id: 4,
    name: 'Dra. Estela Cecília Ferreira',
    crm: 'CRM 69638-SP',
    experience: '+2.000 atendimentos',
    focus: 'Neurologia e sono',
    description: 'Neurologista com mais de 30 anos de experiência e atendimento humanizado.',
    image: '/estela-ferreira.webp',
  },
  {
    id: 5,
    name: 'Dr. Jimmy Fardin',
    crm: 'CRM 31800-BA',
    experience: '+4.000 atendimentos',
    focus: 'Dor crônica e medicina do esporte',
    description: 'Ortopedista e traumatologista com vasta experiência no tratamento da dor crônica.',
    image: '/jimmy-fardin.webp',
  },
  {
    id: 6,
    name: 'Dr. João Lucas Cunico',
    crm: 'CRM 222573-SP',
    experience: '+300 atendimentos',
    focus: 'Ansiedade e dor crônica',
    description: 'Clínico geral com abordagem humanizada, unindo ciência e cuidado personalizado.',
    image: '/joao-cunico.webp',
  },
  {
    id: 7,
  ...
  {
    id: 8,
    name: 'Dr. Luiz Eduardo Costa',
    crm: 'CRM 40367-PR',
    experience: '+400 atendimentos',
    focus: 'Dor crônica e saúde mental',
    description: 'Clínico geral especializado em dor e saúde mental, com abordagem integrativa.',
    image: '/luiz-costa.webp',
  },
]
...
function Doctors() {
  ...
  return (
    <section id="especialistas" className="py-16 md:py-20 overflow-x-hidden" style={{ backgroundColor: '#EDE9FE' }}>
